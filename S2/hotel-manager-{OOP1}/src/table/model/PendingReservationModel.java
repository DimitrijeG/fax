...
public class PendingReservationModel extends TableModel {

    CoreManager app;

    public PendingReservationModel(CoreManager app) {
        super(new String[]{
    ...
    protected ArrayList<Object> getData() {
        return app.reservationManager.pendingReservations();
    }

    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        Reservation reservation = (Reservation) app.reservationManager.pendingReservations().get(rowIndex);
        switch (columnIndex) {
            case 0:
