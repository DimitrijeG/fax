...
class SerialFile(BinaryFile):
    ...
    def delete_by_id(self, id):
        ...
        if next_block and next_block[0]["id"] == self.empty_key:  # ako smo vrsili pomeranje iz poslednjeg bloka, i ako je sada kod njega na prvom mestu prazan slog - mozemo osloboditi memoriju
